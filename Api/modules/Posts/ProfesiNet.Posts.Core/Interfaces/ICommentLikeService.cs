...
{
    Task<Guid>  AddAsync(CreateCommentLikeCommand command, Guid id, CancellationToken ct = default);
    Task DeleteAsync(DeleteCommentLikeCommand command, Guid id, CancellationToken ct = default);
